...
For non-Laravel PHP AI libraries, use manual `gen_ai.*` spans following the [Sentry gen_ai conventions](https://getsentry.github.io/sentry-conventions/attributes/gen_ai/).
