...
> Instrumenting a signal — tracing/spans, logging, metrics, span streaming, AI/LLM monitoring, or deciding what to emit — is part of the standalone `sentry-instrument` skill.
