...
| Setup Sentry monitoring for Claude Code sessions | [`sentry-setup-claude-code-monitoring`](skills/sentry-setup-claude-code-monitoring/SKILL.md) | `sentry-setup-claude-code-monitoring/SKILL.md` |
