...
| Migrating JavaScript/TypeScript console or logger calls to structured Sentry Logs | [`sentry-logs-migration-javascript`](../sentry-logs-migration-javascript/SKILL.md) | `sentry-logs-migration-javascript/SKILL.md` |
